...
public class SalidaProduct {
    public SalidaProduct(JPanel mainPanel) {
    ...
    private JTextField[] textFields(){
        ...
        entrada.putClientProperty("JTextField.placeholderText", " Salida");
        lugar.putClientProperty("JTextField.placeholderText", " Lugar de salida");
    ...
    private JLabel[] labels(){
        ...
        JLabel entrada = new JLabel("Salida del producto");
        JLabel lugar = new JLabel("Lugar de salida del producto");
        return new JLabel[]{
                codigo,
                entrada,
                lugar
    ...
    private JPanel panelProduct(){
        ...
        panelProduct.setBorder(BorderFactory.createLineBorder(new Color(36, 36, 188)));
